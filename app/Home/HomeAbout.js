...
import consultantI from "@/public/consul.svg"
import courseI from "@/public/course.svg"
import blogI from "@/public/blog.svg"
      ...
      <div className="flex flex-col justify-center mx-auto mb-10 md:w-auto">
        ...
        <h3 className=" font-bold lg:text-[36px] text-xl leading-10">
          {language === "bn"
            ...
            : <p>Transform your Career through <span className="text-red-600">Learning</span> </p>}
        </h3>
        <p className="md:px-20 md:pt-3 px-12 pt-1 text-[12px] md:text-[16px]">{language === "bn"
            ...
            : "We aim to democratize AI education in Bangladesh by making it accessible to all learners. Our AI Consultancy Services cater to every individual, addressing their pain points through surveys and offering fundamental and job role-based courses."}</p>
      </div>  
      <div className="mx-6 text-center md:mx-40">
        
        <div className="grid mx-4 mt-4 md:grid-cols-3 md:mt-0 md:mx-2">
