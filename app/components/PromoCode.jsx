  ...
  return (
    <div>
      <section className="p-1 my-5 space-y-5 font-semibold text-slate-900 ">
        ...
        {discount ? discount != 0 ? <><span className="mx-2 text-gray-500 line-through text-md">৳ {courseFee}
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <input
            ...
            className="input input-bordered border-red-500 rounded-md input-sm w-full max-w-[300px] py-6 text-black text-lg bg-white"
          />
          <button
            onClick={() => {
              applyPromoCode();
        ...
        {/* TODO change the final amount by fetching the discount */}
        ...
        <div className="text-center md:block">
          {enrolled ? (
            ...
            <Link className="w-full my-2 text-white bg-black btn hover:bg-black hover:text-white " href='/dashboard/my-courses'> Go To Dashboard</Link>
          </div>
          ) : (
            <Link
              href="/enroll"
