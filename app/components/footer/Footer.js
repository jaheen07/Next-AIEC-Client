  ...
  return (
    <div style={{backgroundImage: `url(${footerBG.src})`,backgroundPosition: 'bottom 10px right -80px',backgroundRepeat: 'no-repeat'}}
     className="bg-[#000000] bg-[image:var(--image-url)] bg-[length:500px_500px] w-full  mx-auto">
      ...
      <div className="grid grid-cols-1 gap-5 text-center text-white md:grid-cols-2 lg:grid-cols-5 md:gap-10 md:text-start">
          ...
          <div className="space-y-[30px] text-center md:text-left">
            <div>
            ...
            <div>
              <h2 className="text-[22px] font-bold text-[#ED1B24] mb-3">
                {language == "bn" ? "আরো কিছু লিঙ্ক" : "Extra as"}
              </h2>
              <div className="flex flex-col gap-2 text-[14px]">
          ...
          <div className="col-span-2 space-y-[60px] text-center md:text-left">
            <div>
              <h2 className="text-[22px] font-bold text-[#ED1B24] mb-3">
                Contact information
              </h2>
        ...
        <div className="mb-6">
          ...
          <div className="mt-4 text-end md:float-right md:mt-12">
            <Link href="https://www.glassdoor.com/Overview/Working-at-AI-Expert-Career-EI_IE9446630.11,27.htm">
              <img alt="Find us on Glassdoor." src="https://www.glassdoor.com/pc-app/static/img/partnerCenter/badges/eng_FIND_US_258x90.png" className="mx-auto" />
            </Link>
          </div>
