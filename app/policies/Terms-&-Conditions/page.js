export default function Page(){  
  return (
    <div className="pt-16 overflow-y-auto">
      <div className="max-w-5xl pb-24 mx-4 bg-white sm:ml-9 ">
        <h1 className="mb-4 text-3xl font-bold">T&amp;C of AI Expert Career</h1>
        ...
        <h2 className="mt-4 text-xl font-semibold">Cookies:</h2>
        <p>
        ...
        <h2 className="mt-4 text-xl font-semibold">License:</h2>
        <p>
        ...
        <h2 className="mt-4 text-xl font-semibold">Parts of this website:</h2>
        <p>
        ...
        <h2 className="mt-4 text-xl font-semibold">Reservation of Rights:</h2>
        <p>
        ...
        <h2 className="mt-4 text-xl font-semibold">Disclaimer:</h2>
        <p>
